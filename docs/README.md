...
# Custom B2B Quotes & Carts

> **_This app is a clone of B2B Quotes & Cart with some level of customisations. Its neme has been changed to echidna.b2b-quotes_**

## In app level changes
2. For disabling the discount option in quote dashboard do the following changes in  `"echidna.b2b-quotes"` app. For doing the you need to add one prop under `""store.b2b-quote-details""` block under `"./store/block.json"`. Its defaul value is false<br>
  
     For example:<br>
     
    ```JSONC
   "store.b2b-quote-details": {
