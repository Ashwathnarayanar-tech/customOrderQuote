...
const QuoteDetails: FunctionComponent<{disableDiscount:boolean}> = (props) => {
  /**
   * constants
   */
  const isDiscountDisabled = props.disableDiscount ? props.disableDiscount : false;
  const {
    route: { params },
    navigate,
  } = useRuntime()
              ...
              <Fragment>
                ...
                <div className="pa5">
                  <QuoteTable
                    ...
                    disableDiscount = {isDiscountDisabled}
                  />
                  {formState.isEditable && isSalesRep && isDiscountDisabled !== true &&(
                    <div className="mt3">
